...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, low_dim=128, in_channel=3, width=1, batch_norm=False):
        self.inplanes = 64
        ...
        #projection MLP
        dim = self.base * 8 * block.expansion
        self.fc1 = nn.Linear(dim, dim)
        self.bn = nn.BatchNorm1d(dim) if batch_norm else None
        self.fc2 = nn.Linear(dim, low_dim)
